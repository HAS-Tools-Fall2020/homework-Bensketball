...
site = '09506000'
start = '1989-01-01'
end = '2020-11-28' # Saturday before perdiction
...
print(flow_predic_mono16 + 27, '\n')
print(flow_predic_poly16 + 27)
...
ax.legend()
# fig1.savefig("graphs/Observed_Log-Flow_Sim.png")
...
# fig1.savefig("graphs/Observed_Log-Flow_Train.png")
...
# An example of saving your figure to a file
# fig2.savefig("graphs/Observed_Flow.png")
...
# An example of saving your figure to a file
# fig3.savefig("graphs/Observed_Log-Flow_Train.png")
